    ...
    <section className="p-10">
      <div className="bg-black p-8 rounded-lg flex flex-col gap-10">
        ...
        <p className="text-[white]">
          ...
          billets et l'accès aux événements organisés par Sound Nation, ci-après
          dénommé "le Festival".
        </p>
        ...
        <div className="bg-[#71A984] p-5 rounded-lg">
          <p>
            <h3 className="underline mb-3 text-lg">1.1. Achat de Billets : </h3>
            Les billets pour le Festival peuvent être achetés en ligne via notre
            site web officiel ou auprès de points de vente autorisés. Les tarifs
            et conditions applicables sont détaillés lors de l'achat.
            <h3 className="underline mb-3 mt-6 text-lg">
              1.2. Accès aux Événements :
            </h3>{" "}
            L'accès aux événements du Festival est soumis à la présentation d'un
            billet valide, qui peut être électronique ou imprimé. Les détenteurs
            de billets doivent se conformer aux règles et aux consignes de
            sécurité établies par les organisateurs.
          </p>
        </div>
        <h2 className="text-[white] underline text-xl">
        ...
        <div className="bg-[#71A984] p-5 rounded-lg">
          <p>
            ...
            cas de dommages corporels, de pertes ou de vols survenus pendant le
            Festival.
            <h3 className="underline mb-3 mt-6 text-lg">
              3.2. Interdictions :
            </h3>{" "}
            Il est strictement interdit d'apporter des substances illicites, des
            armes, des objets dangereux ou tout autre matériel pouvant
            compromettre la sécurité du Festival. Les organisateurs se réservent
            le droit de refuser l'accès à toute personne ne respectant pas ces
            règles.
          </p>
        </div>
        ...
        <div className="bg-[#71A984] p-5 rounded-lg">
          <p>
            ...
            Les contenus audiovisuels, les photographies et les enregistrements
            réalisés lors du Festival sont la propriété intellectuelle des
            organisateurs et ne peuvent être reproduits ou diffusés sans
